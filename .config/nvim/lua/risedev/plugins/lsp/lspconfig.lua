return {
  ...
  keys = {
    ...
    { 'gd',        '<cmd>lua vim.lsp.buf.definition()<CR>' }, { '<leader>gd', 'gd' },
    { 'gD', '<cmd>lua vim.lsp.buf.declaration()<CR>' }, { '<leader>gD', 'gD' },
    { 'K',  '<cmd>lua vim.lsp.buf.hover()<CR>' }, { '<leader>K', 'K' },
    ...
    { '<leader><leader>f', '<cmd>lua vim.lsp.buf.format({ async = true })<CR>' },
    { '<leader>?',        '<cmd>lua vim.lsp.buf.signature_help()<CR>' },
  },
  dependencies = {
