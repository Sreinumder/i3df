return {
  ...
  lazy = false;
  -- keys = {
    --   {"-", ":vsplit<CR><CMD>Oil<CR>", { desc = "Open parent directory" }}
    -- },
    opts = {
      ...
      buf_options = { -- Buffer-local options to use for oil buffers
        buflisted = false,
        bufhidden = "hide",
      },
      win_options = { -- Window-local options to use for oil buffers
        wrap = false,
        signcolumn = "no",
        cursorcolumn = false,
        foldcolumn = "0",
      ...
      -- keymaps = {
        ...
        ssh = { -- Configuration for the floating SSH window
          border = "rounded",
        },
        keymaps_help = { -- Configuration for the floating keymaps help window
          border = "rounded",
        },
      },
      ...
      config = function()
        ...
        vim.keymap.set("n", "<A-->", ":30vsplit<cr><CMD>Oil <CR>", { desc = "Open parent directory" })
      end,
}
