...
def handle_result(args: list[str], answer: str, target_window_id: int, boss: Boss) -> None:
    ...
    toggle_win = next(
        (w for w in tab.windows if w.title == 'toggle_term' and w.user_vars.get('is_toggle_term') == 'true'),
        None
    )
    ...
    elif active.title == 'toggle_term' and active.user_vars.get('is_toggle_term') == 'true':
